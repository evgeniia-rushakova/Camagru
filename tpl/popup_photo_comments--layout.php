...
<div class="photo__container">
	<div class="photo__container--photo_info">
		...
		<div class="photo__reactions">
			<p class="photo__like_counter"> <a class="photo__like_icon" href="../php/likes.php?value=1&photo={img_alt}"><img src="../img/like.png" alt="likes" width="28" height="28"></a><span>{likes} likes</span></p>
			<p class="photo__like_counter"><a class="photo__like_icon" href="../php/likes.php?value=-1&photo={img_alt}"><img src="../img/dislike.png" alt="dislikes" width="28" height="28"></a><span>{dislikes} dislikes</span></p>
